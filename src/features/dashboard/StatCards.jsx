    ...
    return (
        <div className="stats-grid">
            ...
            <div className="stat-card red-accent">
                ...
                <div className="stat-info">
                    <h4>Tunggakan</h4>
                    <div className="value mono" style={{ fontSize: '1.15rem' }}>{formatRupiah(totalUnpaid)}</div>
            ...
            <div className="stat-card green-accent">
                ...
                <div className="stat-info">
                    <h4>Terkumpul</h4>
                    <div className="value mono" style={{ fontSize: '1.15rem' }}>{formatRupiah(totalPaid)}</div>
