...
import { Save, RefreshCw, Globe, Mail, Phone, Share2, Shield, Layout, Radio, MessageSquare } from 'lucide-react'
...
export default function CmsSettingsPage() {
    ...
    const formatLabel = (key) => {
        return key.replace(/^(social_|contact_)/, '').replace(/_/g, ' ').replace(/\b\w/g, l => l.toUpperCase())
    }
    ...
    const generalKeys = ['site_title', 'site_description', 'school_name', 'footer_text']
    const contactKeys = ['contact_email', 'contact_phone', 'contact_address', 'wa_number', 'opening_hours']
