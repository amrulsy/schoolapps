-- ============================================================
-- SIAS SYNC V5 FINAL (MISSING TABLES)
-- Jalankan script ini di phpMyAdmin Hosting untuk mendukung:
-- Rapor Merdeka, Wali Kelas, dan Ekstrakurikuler.
-- ============================================================
...
-- 4. Nilai Semester (Akhir & Deskripsi)
